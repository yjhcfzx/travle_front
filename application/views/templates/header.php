...
<html lang="en">
    <head>
        ...
        <title>我要浪<?php if (isset($page_title) && $page_title) {
    echo ' | ', $page_title;
} ?></title>
        <script>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="my-top-nav">
                    ...
                    <ul class="nav  nav-pills my-pills">
                        <?php
                        foreach ($this->config->item('nav_arr') as $key => $nav_item):
        ...
        <?php echo $text; ?> <span class="caret"></span>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href='<?php echo $this->config->item('base_url'); ?>group'><?php echo $this->lang->line('group_list'); ?></a></li>
                                        <li><a href='<?php echo $this->config->item('base_url'); ?>group/create'><?php echo $this->lang->line('group_create'); ?></a></li>
